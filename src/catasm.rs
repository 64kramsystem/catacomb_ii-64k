...
pub mod stdint_intn_h {
    ...
    use super::types_h::{__int16_t, __int8_t};
}
...
#[c2rust::header_src = "/home/saverio/code/catacomb_ii-64k/source_project/pcrlib.h:20"]
pub mod pcrlib_h {
...
#[c2rust::header_src = "/usr/include/assert.h:20"]
pub mod assert_h {
    extern "C" {
        #[c2rust::src_loc = "69:1"]
...
pub mod catacomb_h {
    use super::catdefs_h::{activeobj, boolean, byte, objdeftype, objtype, sbyte, sword, word};
    extern "C" {
        ...
        pub static mut oldtiles: [libc::c_int; 576];
        ...
        pub static mut priority: [byte; 2048];
        ...
        pub static mut pics: *mut libc::c_char;
        #[c2rust::src_loc = "36:1"]
        pub fn doinactive();
        #[c2rust::src_loc = "35:1"]
        pub fn doactive();
...
use self::catacomb_h::{
    background, doactive, doinactive, frameon, leveldone, numobj, o, obj, objdef, objecton,
    oldtiles, originx, originy, pics, playdone, priority, refresh, view,
};
pub use self::catdefs_h::{
    activeobj, bigshot, boolean, byte, dead1, dead2, dead3, dead4, dead5, dead6, dragon, gargoyle,
    goblin, gune, guns, lastclass, nothing, objdeftype, objtype, ogre, player, rock, sbyte,
    secretgate, shot, skeleton, sword, teleporter, torch, turbogre, wallhit, word, C2RustUnnamed,
};
pub use self::pcrlib_h::{
    grmode, grtype, screenpitch, screenseg, text, C2RustUnnamed_0, CGAgr, EGAgr, UpdateScreen,
    VGAgr, EGA,
};
pub use self::stdint_intn_h::{int16_t, int8_t};
pub use self::stdint_uintn_h::{uint16_t, uint8_t};
use self::string_h::memcpy;
pub use self::types_h::{__int16_t, __int8_t, __uint16_t, __uint8_t};
#[no_mangle]
#[c2rust::src_loc = "33:6"]
